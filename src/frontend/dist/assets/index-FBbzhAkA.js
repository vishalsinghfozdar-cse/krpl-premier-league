...
function Layout({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen flex flex-col items-center", children });
}
const HomePage = reactExports.lazy(() => __vitePreload(() => import("./Home-CV8WhJV3.js"), true ? [] : void 0));
const AdminPage = reactExports.lazy(() => __vitePreload(() => import("./Admin-CuHjKeGM.js"), true ? [] : void 0));
const rootRoute = createRootRoute({
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      reactExports.Suspense,
      {
        fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center min-h-screen text-foreground font-display", children: "लोड हो रहा है..." }),
